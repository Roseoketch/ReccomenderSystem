...
def spliceData(df):
    '''
    reduces the number of datapoints by removing movies with too few reviews and
    users who have given too few reviews
    '''
    f = ['count','mean']
...
def recommend(user, prediction_matrix, mu, movies,R):
    '''
    recommend top 10 movies for the user using Pearson's R
    '''
